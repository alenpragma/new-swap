...
import { BUSD, MIND } from '@pancakeswap/tokens'
...
const cakeBusdPairMap = {
  [ChainId.BSC]: {
    address: Pair.getAddress(MIND[ChainId.BSC], BUSD[ChainId.BSC]),
    tokenA: MIND[ChainId.BSC],
    tokenB: BUSD[ChainId.BSC],
  },
  [ChainId.BSC_TESTNET]: {
    address: Pair.getAddress(MIND[ChainId.BSC_TESTNET], BUSD[ChainId.BSC_TESTNET]),
    tokenA: MIND[ChainId.BSC_TESTNET],
