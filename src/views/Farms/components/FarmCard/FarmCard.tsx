...
const FarmCard: React.FC<React.PropsWithChildren<FarmCardProps>> = ({
  ...
  const lpLabel = farm.lpSymbol && farm.lpSymbol.toUpperCase().replace('PANMIND', '')
  const earnLabel = farm.dual ? farm.dual.earnLabel : t('MIND + Fees')
  ...
  const isPromotedFarm = farm.token.symbol === 'MIND'
