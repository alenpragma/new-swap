...
const PerpetualBanner = () => {
  ...
  const perpetualUrl = useMemo(
    () => `https://pancakeswap.finance/swap?outputCurrency=0x258Ea33a949D8562A2683e1C54D4bAeAd2949F9E`,
    [code, isDark],
  )
  ...
  return (
    <S.Wrapper>
      <S.Inner>
        <S.LeftWrapper>
          <S.StyledSubheading ref={headerRef}>{t('Mindchain Futures')}</S.StyledSubheading>
          <Header width={['160px', '160px', 'auto']}>{t('Up to 100× Profit')}</Header>
