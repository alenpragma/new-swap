...
const emissionsPerBlock = 10.20

/**
 * User (Planet Finance) built a contract on top of our original manual MIND pool,
  ...
  return (
    <Grid>
      ...
      <StyledColumn noMobileBorder style={{ gridArea: 'b' }}>
        ...
        {71000000 ? (
          <Balance decimals={0} lineHeight="1.1" fontSize="24px" bold value={71000000} />
        ) : (
          <>
            <div ref={observerRef} />
            <Skeleton height={24} width={126} my="4px" />
