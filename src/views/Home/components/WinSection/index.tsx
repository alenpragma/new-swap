...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'MIND card' },
    { src: 'green', alt: 'Green MIND card with up arrow' },
    { src: 'red', alt: 'Red MIND card with down arrow' },
    { src: 'top-right', alt: 'MIND card' },
  ],
}
    ...
    <>
      ...
      <TransparentFrame isDark={theme.isDark}>
        <Flex flexDirection="column" alignItems="center" justifyContent="center">
          <ColoredWordHeading textAlign="center" text={t('Great opportunity to earn prizes')} />
          <Text color="textSubtle">{t('Most transparent, blockchain games.')}</Text>
          <Text mb="40px" color="textSubtle">
            {t('Win big with MindchainSwap.')}
          </Text>
