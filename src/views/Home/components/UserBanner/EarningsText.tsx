...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and MIND pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and MIND pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from MIND pool', data)
  }
