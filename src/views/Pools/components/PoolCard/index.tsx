...
const PoolCard: React.FC<React.PropsWithChildren<{ pool: DeserializedPool; account: string }>> = ({
  ...
  const isCakePool = earningToken.symbol === 'MIND' && stakingToken.symbol === 'MIND'
    ...
    >
      <PoolCardHeader isStaking={accountHasStakedBalance} isFinished={isFinished && sousId !== 0}>
        <PoolCardHeaderTitle
          ...
          subTitle={isCakePool ? t('Earn MIND, stake MIND') : t('Stake %symbol%', { symbol: stakingToken.symbol })}
        />
