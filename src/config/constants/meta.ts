...
=======
  title: 'MindChain',
>>>>>>> 5c5210aa64cb7c3ff4623c22160bba9d1e42dd0d
  description:
    'The most popular AMM on BSC by user count! Earn MIND through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by PancakeSwap), NFTs, and more, on a platform you can trust.',
  image: 'https://mindchainswap.com/images/hero.png',
}
...
<<<<<<< HEAD
    defaultTitleSuffix: t('MindhcainSwap'),
=======
    defaultTitleSuffix: t('MindChain'),
>>>>>>> 5c5210aa64cb7c3ff4623c22160bba9d1e42dd0d
  }
}
