...
export interface MasterchefInterface extends utils.Interface {
  functions: {
    "ACC_MIND_PRECISION()": FunctionFragment;
    "BOOST_PRECISION()": FunctionFragment;
    "MIND()": FunctionFragment;
    "MIND_RATE_TOTAL_PRECISION()": FunctionFragment;
    "MASTERCHEF_MIND_PER_BLOCK()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "ACC_MIND_PRECISION",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "MIND", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "MIND_RATE_TOTAL_PRECISION",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MASTERCHEF_MIND_PER_BLOCK",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "MIND", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "MIND_RATE_TOTAL_PRECISION",
    data: BytesLike
  ): Result;
...
export interface Masterchef extends BaseContract {
  ...
  functions: {
    ACC_MIND_PRECISION(overrides?: CallOverrides): Promise<[BigNumber]>;

    BOOST_PRECISION(overrides?: CallOverrides): Promise<[BigNumber]>;

    MIND(overrides?: CallOverrides): Promise<[string]>;

    MIND_RATE_TOTAL_PRECISION(overrides?: CallOverrides): Promise<[BigNumber]>;

    MASTERCHEF_MIND_PER_BLOCK(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  estimateGas: {
    ...
    MIND(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    MIND(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    MIND_RATE_TOTAL_PRECISION(
      overrides?: CallOverrides
    ): Promise<PopulatedTransaction>;

    MASTERCHEF_MIND_PER_BLOCK(
      overrides?: CallOverrides
    ): Promise<PopulatedTransaction>;
