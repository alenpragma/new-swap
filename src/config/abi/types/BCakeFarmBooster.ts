...
export interface BCakeFarmBoosterInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "MIND_POOL", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "MIND_POOL", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "CA_PRECISION",
    data: BytesLike
  ): Result;
...
export interface BCakeFarmBooster extends BaseContract {
  ...
  functions: {
    ...
    MIND_POOL(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    MIND_POOL(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    MIND_POOL(overrides?: CallOverrides): Promise<PopulatedTransaction>;
