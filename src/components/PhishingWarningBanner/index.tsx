...
const PhishingWarningBanner: React.FC<React.PropsWithChildren> = () => {
  ...
  const warningTextAsParts = useMemo(() => {
    const warningText = t("Please check that you're visiting https://mindchainswap.com - check the URL carefully.")
    return warningText.split(/(https:\/\/mindchainswap.com )/g)
  }, [t])
  const warningTextComponent = (
    <>
      <Text as="span" color="danger" small bold textTransform="uppercase">
        {t('Scam Alert:')}
      </Text>
